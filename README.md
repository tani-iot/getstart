...
ถูกใช้เป็นตัวกลางในการติดตั้งซอฟต์แวร์จำนวนมา
อาทิเช่น AI ซอฟต์แวร์ทางวิทยาศาสตร์ เป็นต้น
...
### 2.2 เหมือนดาวน์โหลดมาแล้ว ให้รันโปรแกรมติดตั้ง python
...
ถ้าติดตั้งสำเร็จa จะปรากฎข้อความประมาณนี้
```
...
```
